...
loan_txt = "Please note that all loan requests must be made at least 1 week in advance, and for a maximum of 3 consecutive days. The loan request can only be made within the 2 weeks window starting from one week after today. For additional queries, please contact " + tcontacts.handle_1 + ".\n\n"
